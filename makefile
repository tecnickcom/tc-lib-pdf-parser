...
PKGNAME=php-tc-lib-pdf-parser

# Default installation path for code
LIBPATH=usr/share/php/Com/Tecnick/Pdf/Parser/
...
help:
	@echo ""
	@echo "Welcome to tc-lib-pdf-parser make."
...
docs:
	@rm -rf target/phpdocs && ./vendor/phpdocumentor/phpdocumentor/bin/phpdoc project:run --target="target/phpdocs/" --directory="src/" --ignore="vendor/" --encoding="UTF-8" --title="tc-lib-pdf-parser" --parseprivate
